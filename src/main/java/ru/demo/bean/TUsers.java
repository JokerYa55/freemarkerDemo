...
public class TUsers implements Serializable {
    ...
    public String toString() {
        return "TUsers{" + "id=" + id + ", createDate=" + createDate + ", description=" + description + ", email=" + email + ", enabled=" + enabled + ", firstname=" + firstname + ", hashType=" + hashType + ", lastname=" + lastname + ", password=" + password + ", phone=" + phone + ", salt=" + salt + ", thirdname=" + thirdname + ", updateDate=" + updateDate + ", userRegion=" + userRegion + ", userStatus=" + userStatus + ", username=" + username + ", emailVerified=" + emailVerified + '}';
    }
